...
public class InputManager : MonoBehaviour
{
    ...
    void HandleMenuButton()
    {
        ...
        // On menu button press (edge trigger)
        if (menuPressed && !wasMenuPressed)
        {
            ...
            {
                Debug.Log("InputManager: Grip + Menu button - Removing monitor");
                ...
                if (rightHandAnchor != null)
                {
                    ...
                    if (monitorToRemove != null)
                    {
                        ...
                        Debug.Log("InputManager: Monitor removed successfully");
                    }
                    else
                    {
                        Debug.Log("InputManager: No monitor found under pointer");
                    }
                }
            }
            else
            {
                // Otherwise (menu button alone), spawn a monitor
                Debug.Log("InputManager: Menu button pressed - Spawning next monitor");
